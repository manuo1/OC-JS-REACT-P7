...
function refreshRecipesByMainSearchV2(searchText, recipeList) {
...
function refreshRecipesByMainSearchV1(searchText, recipeList) {
  if (searchText === "" || searchText.length < 3) {
    return recipeList;
  }
...
const searchTerms = ["ananas", "coco", "poulet", "tarte", "chocolat", "salade", "citron", "miel", "banane", "fraise"];
